...
<template>
    <AuthenticatedLayout>
      <Head :title="pageName" />
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto mb-2 sm:px-6 lg:px-8">
                <form class="bg-white overflow-hidden shadow-sm sm:rounded-lg sm:px-6 sm:py-2 lg:px-8 lg:py-3" @submit.prevent="submit">
